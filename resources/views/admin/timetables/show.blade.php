    ...
    <div class="card">
        ...
        <div class="card-body ">
            <div class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework">
                ...
                <div class="col-12">
                    <div class="col-md-6 fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                        <label class="form-label" for="end">{{ __('app.tour_type_singular') }}</label>
                        <input type="text" id="end" value="{{ $timetable->tourType->name  }}" class="form-control"  name="end" disabled>
                    </div>
                </div>
                <div class="col-12">
                    <div class="col-md-6 fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
