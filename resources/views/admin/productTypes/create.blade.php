...
@php
    ...
    $breadcrumbs = [ __('app.home')=> route('admin.home'),__('app.product_type') => route('product-type.create'),  __('app.create') => false];
@endphp
        ...
        <div class="card-header">
            <div class="container-fluid">
                <div class="float-start">
                    <h4>{{ __('app.create_tittle',['object' =>  __('app.product_type_singular')]) }}</h4>
                </div>
            </div>
        </div>
        <div class="card-body ">
            <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('product-type.store')  }}" method="post" >
                @csrf
                <div class="col-12">
