...
@php
    ...
    $breadcrumbs = [ __('app.home') => route('admin.home'),__('app.tour_states') => route('tour-state.index'), __('app.create') => false];
@endphp
        ...
        <div class="card-header">
            <div class="container-fluid">
                <div class="float-start">
                    <h4>{{ __('app.create_tittle',['object' =>  __('app.tour_states_singular')]) }}</h4>
                </div>
            </div>
        </div>
        <div class="card-body ">
            <form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('tour-state.store')  }}" method="post" >
                @csrf
                <div class="col-12">
