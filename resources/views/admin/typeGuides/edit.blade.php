...
@php
    ...
    $breadcrumbs = [__('app.home')=> route('admin.home'),__('app.type_guides')=> route('type-guides.index'), __('app.crud_edit') => false];
@endphp
        ...
        <div class="card-header">
            <div class="container-fluid">
                <div class="float-start">
                    <h4>{{ __('app.edit_tittle',['object' =>  __('app.type_guides_singular')]) }}</h4>
                </div>
            </div>
        </div>
        <div class="card-body ">
